...
a = Analysis(
    ...
    hiddenimports=[
        ...
        "numpy",
        "pydub",
        # 人声分离/说话人识别在 core 函数内延迟导入，打包时显式保留运行时依赖。
        "sherpa_onnx",
        "soundfile",
        "videocaptioner.core.separation",
        "videocaptioner.core.separation.vocal_separator",
        "videocaptioner.core.diarization",
        "videocaptioner.core.diarization.speaker_diarizer",
        "videocaptioner.core.diarization.assign",
        "videocaptioner.core.dubbing.narrator_filter",
        "videocaptioner.core.dubbing.narrator_llm_judge",
        "videocaptioner.core.utils.video_filters",
        "gradio_client",
        "diskcache",
        "tenacity",
        "json_repair",
