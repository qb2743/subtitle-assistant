...
class Config(QConfig):
    ...
    dubbing_fixed_line_pause_ms = RangeConfigItem(
        "Dubbing", "FixedLinePauseMs", 1000, RangeValidator(100, 5000)
    )
    ...
    dubbing_clone_audio_text = ConfigItem("Dubbing", "CloneAudioText", "")
    dubbing_local_start_script = ConfigItem("Dubbing", "LocalStartScript", "")
    dubbing_local_start_timeout = RangeConfigItem(
        "Dubbing", "LocalStartTimeout", 180, RangeValidator(10, 600)
    )
    dubbing_local_package_url = ConfigItem("Dubbing", "LocalPackageUrl", "")
    dubbing_dots_package_url = ConfigItem("Dubbing", "DotsPackageUrl", "")
    dubbing_voxcpm_package_url = ConfigItem(
        "Dubbing",
        "VoxCPMPackageUrl",
        "https://huggingface.co/mortimerme/repocollect/resolve/main/f5-tts0528.7z",
    )
    dubbing_dots_url = ConfigItem("Dubbing", "DotsUrl", "http://127.0.0.1:7860")
    dubbing_dots_start_script = ConfigItem("Dubbing", "DotsStartScript", "")
    dubbing_voxcpm_url = ConfigItem("Dubbing", "VoxCPMUrl", "http://127.0.0.1:9880")
    dubbing_voxcpm_start_script = ConfigItem("Dubbing", "VoxCPMStartScript", "")
    dubbing_voxcpm_version = OptionsConfigItem(
        "Dubbing", "VoxCPMVersion", "v2", OptionsValidator(["v2", "v1", "hf"])
    )
