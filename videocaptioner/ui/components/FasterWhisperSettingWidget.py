...
from videocaptioner.ui.components.transcription_settings_style import (
...
class FasterWhisperSettingWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        self.scrollArea.setObjectName("fasterWhisperSettingScroll")
        ...
        self.container.setObjectName("fasterWhisperSettingContainer")
